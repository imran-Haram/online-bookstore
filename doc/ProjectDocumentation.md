...
| — | **Development Tools** *(`doc/Tools-Visual.html`)* | A comprehensive catalog of all 26 tools used during development — organized into 7 categories: Backend (PHP, Laravel, Breeze, Composer, Artisan), Frontend (Blade, Tailwind CSS, Alpine.js, Axios), Database (MySQL, phpMyAdmin, Eloquent, Migrations), Build (Vite, Node.js, npm, PostCSS), Development Environment (Laragon, VS Code, PowerShell, Browser), Version Control (Git, GitHub), and Design/Documentation (SVG, Markdown, HTML5/CSS3). |
